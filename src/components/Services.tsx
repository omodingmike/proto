        ...
        <div className={"grid grid-cols-1 md:grid-cols-4 gap-16"}>
            {
                services.map((service, index) => (
                        <div key={index}
                            ...
                            <h5 className="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white text-start">{service.title}</h5>
                            <p className="mb-3 font-normal text-gray-500 dark:text-gray-400 text-start">{service.body}</p>
                        </div>
                    )
                )
            }
