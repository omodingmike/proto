...
import NewDestination from "./pages/NewDestination.tsx";
import FilteredDestinations from "./pages/FilteredDestinations.tsx";
import UpdateDestination from "./pages/UpdateDestination.tsx";
    ...
    return (
        <>
            <Routes>
                ...
                <Route path="/filtered/:name" element={<FilteredDestinations/>}/>
